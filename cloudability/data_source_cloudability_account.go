	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"parent_account_id": &schema.Schema{
				Type:        schema.TypeString,
				Computed:    true,
				Description: "12 digit string representing parent's account ID",
			},
			"role_name": &schema.Schema{
				Type:        schema.TypeString,
				Computed:    true,
				Description: "The name of the expected IAM role. Currently hardcoded to CloudabilityRole",
			},
...
func dataSourceAccountRead(d *schema.ResourceData, meta interface{}) error {
	...
	account, err := client.Poll(accountID, config.PayerAccountID)
	if err != nil {
		return err
	}
